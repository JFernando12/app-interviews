    ...
    <nav className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-sm border-b border-gray-200/50 dark:border-gray-800/50 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Mobile menu section - Visible only on mobile */}
                ...
                {session ? (
                  <div className="space-y-3">
                    <Link
                      href="/profile"
                      onClick={handleMobileNavClick}
                      className="flex items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-xl transition-all duration-200 active:scale-95"
                    >
                      {session.user?.image ? (
                        <img
                          src={session.user.image}
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 rounded-xl text-base font-medium text-red-600 hover:text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 transition-all duration-200 active:scale-95"
                    >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center px-4 py-3 rounded-xl text-base font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 active:scale-95"
                  >
